...
import com.sun.image.codec.jpeg.JPEGImageEncoder;
 ...
 public class ImageCompareDemo {
	...
	public static void main(String[] args) {
		...
		ImageCompareDemo ic = new ImageCompareDemo("/home/donglei/test-videos/output/thumbnails-01.jpeg",
				"/home/donglei/test-videos/output/thumbnails-01.jpeg");
	...
	public ImageCompareDemo(String file1, String file2) {
		this(loadJPG(file1), loadJPG(file2));
	}

	// constructor 2. use awt images.
	public ImageCompareDemo(Image img1, Image img2) {
	...
	public ImageCompareDemo(BufferedImage img1, BufferedImage img2) {
		this.img1 = img1;
		this.img2 = img2;
		autoSetParameters();
	}
